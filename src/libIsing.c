...
void runIsing(char *IsingGrid, int *IsingNtk, double T, int tmax, double orders[], char fname[]){
...
void runIsing_w_pthread(char *IsingGrid, int *IsingNtk, double T, int tmax, double orders[], char fname[]){

    int i;
    double mall=0, m2=0, m4=0, m[TSTEADY], sus, bin_cum, pdE[2];
